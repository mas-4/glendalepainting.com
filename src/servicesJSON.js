...
const Data = [
    ...
    },
    {
        ...
        pic: stucco,
        body: [
            "Today’s concrete buildings deteriorate. They deteriorate for a variety of reasons. Many of which are avoidable. But when these conditions exist, the painting contractor should be prepared to, and experienced in, making the needed repairs.",
